...
def HaloWST_one_f_MASL(filename, snapdir, snapnum=2, N_hgrid=128, hlength=1000, N_WSTgrid=128, j=4, l=4, i=-1):
    ...
    NB: this function uses MAS:library.MA() to generate density matrix, not myCIC
